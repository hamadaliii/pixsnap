...
interface PhotoGridProps {
  photos: Photo[]
  /** If true, shows a delete button on hover (admin mode) */
  allowDelete?: boolean
    ...
    <>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
        {photos.map((photo) => (
          <div
            key={photo.id}
            className="group relative aspect-square rounded-lg overflow-hidden bg-neutral-100 dark:bg-neutral-800 cursor-pointer"
